...
public class LeshanServerNethead{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(LeshanServerNethead.class);
    ...
    public static void createAndStartServer(String webAddress, int webPort, String localAddress, int localPort,
        ...
        root.setContextPath("/");
        root.setResourceBase(LeshanServerNethead.class.getClassLoader().getResource("webapp").toExternalForm());
